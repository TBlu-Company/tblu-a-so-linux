...
const linuxBlockDevice = require('./actions/linuxBlockDevice')
...
exports.run = (data) => new Promise((resolve, reject) => {
    switch (data.moduleFunction) {
        ...
        case "mLinuxMemory":
            ...
            break;
        case "mLinuxBlockDevice":
            linuxBlockDevice(data).then(result => resolve(result)).catch(error => reject(error));
            break;
        default:
